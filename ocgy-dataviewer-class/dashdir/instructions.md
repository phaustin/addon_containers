### EOSC 372 Class Activity

#### Instructions  

- Hover over a station (dots on the map) to display corresponding oxygen, DIC (dissolved inorganic carbon), pH, nitrate, phosphate and N* profiles.
