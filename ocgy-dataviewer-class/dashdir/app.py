...
initial_cruise = "Selected Cruises"
initial_y_range = [0, 2000]
...
app = dash.Dash(__name__,server=server,
                                requests_pathname_prefix='/ocgy-class/',  # comment out this line to run locally. Keep for deploying on server.
